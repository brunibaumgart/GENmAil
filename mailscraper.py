...
#         current_person = person
    #else:
# current_person = Person(6103329712, "nicosuarez272@gmail.com", "asdf")

def parseo(current_mail, keywords, reject_keywords, favorites_senders, reject_senders, favorite_mails):
    global messages
    current_person=current_mail
    ...
    try:
        ...
        if not messages:
            ...
            # turn elements in favorite_mails into a string
            favorite_mails = ''.join(favorite_mails)
            # concatenate favorite_mails with string_mail
            string_mail = favorite_mails + string_mail
            prompt_maker(string_mail)
